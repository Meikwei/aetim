...
import (
	...
	"github.com/Meikwei/aetim/pkg/rpccache"
...
// ClearMsg implements msg.MsgServer.
func (m *msgServer) ClearMsg(context.Context, *msg.ClearMsgReq) (*msg.ClearMsgResp, error) {
	panic("unimplemented")
}
