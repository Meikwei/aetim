...
import (
	...
	"github.com/Meikwei/aetim/pkg/common/convert"
	"github.com/Meikwei/aetim/pkg/common/db/cache"
	"github.com/Meikwei/aetim/pkg/common/db/controller"
	"github.com/Meikwei/aetim/pkg/common/db/mgo"
	tablerelation "github.com/Meikwei/aetim/pkg/common/db/table/relation"
	"github.com/Meikwei/aetim/pkg/common/servererrs"
	"github.com/Meikwei/aetim/pkg/rpcclient"
...
// UpdateConversation implements conversation.ConversationServer.
func (c *conversationServer) UpdateConversation(context.Context, *pbconversation.UpdateConversationReq) (*pbconversation.UpdateConversationResp, error) {
	panic("unimplemented")
}
